<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy of AbouUs.aspx.cs" Inherits="AbouUs" %>
...
<head>
    ...
    <title>Home | Alllmaa IT Solution Pvt Ltd</title>
...
<body class="homepage">
    ...
    <section id="feature" >
        ...
        <div class="center wow fadeInDown">
                <h2>About Emulate.</h2>
                <p class="lead">EIPL a premier IT Company provides you a complete range of solutions facing the ever-growing client and market challenges. We give you Internet solutions that are reliable, scalable and highly customized for your needs. EIPL Design Studio uses the best of web technologies for your customized web development and optimization. The processes involved are highly professional and can assure you appreciable success. Our committed experts guarantee you quality work that is highly competent in the Internet market creating a dynamic presence to improve your online business. We can develop applications that serve your specific commercial needs, modify and enhance your existing systems by just including some more customized features that would benefit you. We believe in giving you solutions that are usable, aesthetic and functional that can help in enhancing your business</p>
            </div>

          <div class="center wow fadeInDown">
                <h2>Our Approach.</h2>
                <p class="lead">We always aim to build a website exactly to the client's imagination, one that fulfills their needs. To achieve such perfection, we pay dedicated attention soaked in the essence of your business. To realize such a professional artwork, we follow below mentioned steps to ensure you have a precise end- product:</p>
              <p class="lead">• Requirements elicitation
...
• Website deployment
• Website maintenance / Internet Marketing</p>
            </div>
