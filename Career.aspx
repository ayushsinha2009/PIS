<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Career.aspx.cs" Inherits="Careers" %>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">OUR OPENINGS</a>
          </div>
       ...
       <div class="col-md-8">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">UX ENGINEER</h5>
              ...
              <div class="card-body">
                    ...
                    <div class="col-md-12 pr-3">
                      <div class="form-group">
                        <label>POST : </label>
                          <asp:Label ID="lblpost" runat="server" Text="Label">
                  ...
                  <div class="col-md-12 pr-3">
                      <div class="form-group">
                       <label>TECHNOLOGY :</label>
                         <asp:Label ID="lbltechnology" runat="server" Text="Label">
                      ...
                      <div class="form-group">
                        ...
                        <asp:Label ID="lbldesc" runat="server" Text="Label">
						  ...
						  <div class="col-md-12">
                      <div class="form-group">
                        <label>JOB POSTING STATUS :</label>
		 ...
		 <%-- <div class="col-md-8">
		  ...
		  <div class="col-md-8">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">MEAN DEVELOPER</h5>
	      ...
	      <div class="col-md-8">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">HR GENERALIST</h5>
		  ...
		  --%>
           <asp:GridView ID="GVcareer" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" Width="1020px" CellPadding="3" CellSpacing="2">
