...
<form runat="server">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">HOLIDAY DETAILS</a>
          </div>
  ...
  <canvas id="bigDashboardChart"></canvas>
      ...
      <div class="content">
          ...
          <div class="col-md-8">
                  ...
                  <div class="col-md-12 pr-3">
                      <div class="form-group">
                       <label>NAME OF HOLIDAY :</label>
                         <asp:Label ID="lblholiday" runat="server" Text="Label"></asp:Label>
            ...
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">VIEW HOLIDAYS</h5>
				  
				 
				  
				</div>
			    <asp:GridView ID="gvholidays" runat="server" CellPadding="3" Height="44px" Width="890px" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellSpacing="2">
                                    <Columns>
  ...
  <script src="../assetss/js/paper-dashboard.min.js?v=2.0.0" type="text/javascript"></script>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-sm-6">
                   ...
                   <asp:GridView ID="gvholidays" runat="server" CellPadding="4" EnableModelValidation="True" ForeColor="#333333" GridLines="None" Height="44px">
