...
<head>
    ...
    <link href="//maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css1/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
    <script src="//maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js1/bootstrap.min.js"></script>
...
<body>
    <div class="container">
        <div style="text-align: center">
                   ...
                   <img src="https://i.ibb.co/rxKLQ4S/19-1-User-512.png" alt="photo" style="width:20%" />
        </div>
            ...
            <div class="card ">
                ...
                <p class="lead">
                    <form style="width: 100%;">
                        ...
                        <tr>
                            <td class="auto-style2">&nbsp;</td>
                            <td><strong>UserName *</strong><asp:TextBox ID="txtusername" runat="server" autoComplete="off" ValidationGroup="l"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtusername" ErrorMessage="Enter UserName " ValidationGroup="l"></asp:RequiredFieldValidator>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="auto-style2">&nbsp;</td>
                            <td><strong>Password *</strong><asp:TextBox ID="txtpwd" runat="server" TextMode="Password" autoComplete="off" ValidationGroup="l"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtpwd" ErrorMessage="Enter Password" ValidationGroup="l"></asp:RequiredFieldValidator>
                            </td>
                            <td>&nbsp;</td>
                        </tr>--%>
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i  class='fas fa-user ml-2' style='font-size: 23px; color:white;'></i></span>
                                <asp:TextBox ID="txtusername" class="form-control" placeholder="UserName" autoComplete="off" ValidationGroup="l" runat="server"></asp:TextBox>
                            </div>
                           
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
							ControlToValidate="txtusername" ErrorMessage="Enter UserName" ValidationGroup="l" ForeColor="Red" ></asp:RequiredFieldValidator>
                        </div>
                        <div class="input-group form-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class='fa fa-key ml-2' style='font-size: 22px; color:white;'></i></span>
                                <asp:TextBox ID="txtpwd" class="form-control" TextMode="Password" placeholder="Enter Password"  runat="server" autoComplete="off" ValidationGroup="l"></asp:TextBox>
                            </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" SetFocusOnError="true" runat="server" ErrorMessage="Password is Required!" 
							ControlToValidate="txtpwd" ValidationGroup="l" ForeColor="Red" ></asp:RequiredFieldValidator>
                        </div>
                        <tr>
                            <td class="auto-style2">&nbsp;</td>
                            <td>
                                <asp:Button ID="BtnLogin" runat="server" Text="Login" class="button button3" OnClick="BtnLogin_Click" ValidationGroup="l" style="margin-left:70px;" />
                                <asp:Button ID="BtnCancel" runat="server" class="button button3" OnClick="BtnCancel_Click" Text="Cancel" />
                        <asp:Button ID="btnForgotPassword" style="margin-left:100px;" runat="server" class="button button3" OnClick="btnForgotPassword_click" Text="ForgotPassword" />
            ...
            function b(b, d) {
                function e() {
                    if (w) {
                        ...
                        B && !A && window.addEventListener("deviceorientation", function () { D = Math.min(Math.max(-event.beta, -30), 30), C = Math.min(Math.max(-event.gamma, -30), 30) }, !0), g(), o("onInit")
                    }
                } function f() {
                    p.width = v.width(),
                    ...
                    if (w) {
                        ...
                        for (var b = 0; b < x.length; b++) x[b].updatePosition(); for (var b = 0; b < x.length; b++) x[b].draw(); E || (r = requestAnimationFrame(g))
                    }
                } function h() {
                ...
                } function j() { E = !0 } function k() { E = !1, g() } function l() {
                ...
                } function m(a, b) { return b ? void (d[a] = b) : d[a] } function n()
                ...
                C = 0, D = 0, E = !1; return d = a.extend({}, a.fn[c].defaults, d), l.prototype.draw = function () {
                    q.beginPath(), q.arc(this.position.x + this.parallaxOffsetX,
                    this.position.y + this.parallaxOffsetY, d.particleRadius / 2, 0, 2 * Math.PI, !0), q.closePath(), q.fill(), q.beginPath(); for (var a = x.length - 1; a > this.stackPos; a--) {
                    ...
                    if (d.parallax) {
                        if (B && !A) {
                            var a = (s - 0) / 60; pointerX = (C - -30) * a + 0;
                            var b = (t - 0) / 60; pointerY = (D - -30) * b + 0
                        } else pointerX = y, pointerY = z; this.parallaxTargX = (pointerX - s / 2) / (d.parallaxMultiplier * this.layer), this.parallaxOffsetX += (this.parallaxTargX - this.parallaxOffsetX) / 10,
                    ...
                    switch (d.directionY) {
                        case "up": this.position.y + this.speed.y + this.parallaxOffsetY < 0 && (this.position.y = v.height() - this.parallaxOffsetY); break; case "down":
                ...
                }, l.prototype.setStackPos = function (a) { this.stackPos = a }
                ...
                if ("string" == typeof arguments[0]) {
                    ...
                    this
                } return "object" != typeof d && d ? void 0 : this.each(function () { a.data(this, "plugin_" + c) || a.data(this, "plugin_" + c, new b(this, d)) })
            }, a.fn[c].defaults = {
                minSpeedX: .1, maxSpeedX: .7, minSpeedY: .1, maxSpeedY: .7,
