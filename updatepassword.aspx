...
<body>
  ...
  Login Panel</h2>
                    ...
                    <form style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                                 ...
                                 <table class="auto-style2"style="border-style: double; border-color: inherit; border-width: medium; height:153px; width:394px;">
            <tr>
                <td class="auto-style3">GET YOUR PASSWORD</td>
            ...
            <tr>
                <td>
                    <asp:Button ID="btnfgp" runat="server" Text="Button" OnClick="btnfgp_Click1" />
                </td>
             
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblusemame" runat="server"></asp:Label>
                </td>
                <td>
...
<body>
    <form id="form1" runat="server">
    <div>
        Employee Name<asp:TextBox ID="txtempname" runat="server" autocomplete="off"></asp:TextBox>
        <asp:Button ID="btnfgp" runat="server" Text="Button" OnClick="btnfgp_Click" />  
        <asp:Label ID="lblusername" runat="server"></asp:Label>&nbsp&nbsp&nbsp&nbsp&nbsp
        <asp:Label ID="lblpassword" runat="server"></asp:Label>
        </div>
    </form>
</body>
