...
<body id="top">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <p><i class="fa fa-phone"></i><span>Phone</span>+91 7379762970</p>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <p><i class="fa fa-envelope-o"></i><span>Email</span><a href="mailto:info@sonuojha.in">info@sonuojha.in</a></p>
                </div>
                <div class="col-md-5 col-sm-4 col-xs-12">
                    <ul class="social-icon">
                        <li><span>Meet us on</span></li>
                        <li><a href="Facebook.com/AlllmaaaIT" class="fa fa-facebook"></a></li>
                        <li><a href="@omegaapiind" class="fa fa-twitter"></a></li>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="../EmployeeLogin.aspx">LOGIN</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    <h1 class="wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s">ALLLMAA IT <span>SOLUTION PVT. LTD.</span></h1>
                    <div class="element">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInLeft" data-wow-offset="50" data-wow-delay="0.6s">
                    <div class="media">
                        <div class="media-heading-wrapper">
                            ...
                            <h3 class="media-heading">ABOUT US 1</h3>
                        </div>
                        <div class="media-body">
                            <p style="text-align: justify;">
                                We   are an IT   company providing all types of Recharge like Mobile Recharge, 
								DTH   Recharge,Bill Payments,Online Money Transfer,Traveling   Services like 
								Hotel Booking,Taxi/Cab Booking and Online Shopping
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-offset="50" data-wow-delay="0.9s">
                    <div class="media">
                        <div class="media-heading-wrapper">
                            ...
                            <h3 class="media-heading">ABOUT US 2</h3>
                        </div>
                        <div class="media-body">
                            <p style="text-align: justify;">
                                We   are an IT   company providing all types of Recharge like Mobile Recharge, 
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
                    <div class="media">
                        <div class="media-heading-wrapper">
                            ...
                            <h3 class="media-heading">ABOUT US 3</h3>
                        </div>
                        <div class="media-body">
                            <p style="text-align: justify;">
                                We   are an IT   company providing all types of Recharge like Mobile Recharge, 
    ...
    <section id="team">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s"><span>ALLLMAA</span> TEAM</h2>
                </div>
    ...
    <section id="portfolio">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s"><span>ALLLMAA</span> PORTFOLIO</h2>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
                    <address>
                        ...
                        <span>4/72 Vipul Khand 4<br>
                            Infront of IMRT Business School Near to SRS Mall<br>
                            Uttar Pardesh</span>
                        <p><i class="fa fa-phone"></i>+91 7379762970</p>
                        <p><i class="fa fa-envelope-o"></i>info@sonuojha.in</p>
                    ...
                    <ul class="social-icon">
                        ...
                        <li><a href="Facebook.com/AlllmaaIT" class="fa fa-facebook"></a></li>
                        <li><a href="@omegaapiind" class="fa fa-twitter"></a></li>
                        <li><a href="https://www.youtube.com/channel/UC4yzoGuKkCL_8FzI-B-x83A" class="fa fa-youtube"></a></li>
                    </ul>
                </div>
    ...
    <section id="login">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s">LOGIN <span>HERE</span></h2>
                </div>
                <div class="col-md-12 col-sm-6 col-xs-12 wow fadeInLeft" data-wow-offset="50" data-wow-delay="0.9s">
                    <form action="#" method="post">
                        <label>NAME</label>
                        <input name="fullname" type="text" class="form-control" id="Text1">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s">
                        Copyright &copy; 2019. Designed By ALLLMAA IT SOLUTION PVT. LTD.
                    </p>
                </div>
            </div>
        </div>
