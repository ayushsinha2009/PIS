<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeFile="AddCurriculumn.aspx.cs" EnableEventValidation="false" Inherits="AdminLogin_AddCurriculumn" %>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">CURRICULUM MASTER</a>
          </div>
        ...
        <section class="content">
                ...
                <div class="col-sm-6">
                    <div class="panel lobidisable panel-bd">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label>Topic</label><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtdesc" CssClass="form-control" ErrorMessage="*" ValidationGroup="c"></asp:RequiredFieldValidator>
                              ...
                              <div class="form-group">
                                <label>Curriculum Description</label><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtdesc" ErrorMessage="*" ValidationGroup="c"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-group">
                                ...
                                <asp:Button ID="BtnAdd" CssClass="btn btn-primary btn-block" runat="server" Text="Add Curriculmn" ValidationGroup="c" OnClick="BtnAdd_Click" />
                               <asp:Button ID="Btnupdate" CssClass="btn btn-primary btn-block" runat="server" Text="Update Curriculmn" OnClick="Btnupdate_Click"  />
                                <asp:Button ID="Btndel" CssClass="btn btn-primary btn-block" runat="server" Text="Delete Curriculmn" OnClick="Btndel_Click" />
                                <asp:Button ID="Btncncl" CssClass="btn btn-primary btn-block" runat="server" Text="Cancel" OnClick="Btncncl_Click" />
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="panel-title">
                                ...
                                <h4>Curriculum Master Details</h4>
                            </div>
                    ...
                    <asp:BoundField DataField="Curriculumndesc" HeaderText="Curriculum Description" />
