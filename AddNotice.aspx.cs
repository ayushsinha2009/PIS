...
using System.Data;
using System.IO;
public partial class AdminLogin_AddNotice : System.Web.UI.Page
{
    ...
    {
        i = obj.AddNotice(txtdate.Text.Trim(), txttopic.Text.Trim(), txtdesc.Text.Trim(), "Admin", 1, DateTime.Now.ToString());
        if (i > 0)
        {
            bindgrid();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        Response.ContentType = "application/Notice.ms-excel";
    ...
    {
        int EmpId = (Convert.ToInt32(ddnemp.SelectedValue));
        dt = obj.SelectNtotice(EmpId);
    ...
    {
        u = obj.UpdateNotice(Convert.ToInt32(lblId.Text), txtdate.Text, txttopic.Text, txtdesc.Text);
        if (u > 0)
        {
    ...
    {
        d = obj.DeleteNotice(Convert.ToInt32(lblId.Text));
        if (u > 0)
        {
    ...
    protected void ddldeprt_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ddnemp.DataSource = dt2;
        ddnemp.DataTextField = "EmpFirstname";
        ddnemp.DataValueField = "EmpId";
        ddnemp.DataBind();
        ddnemp.Items.Insert(0, new ListItem("Select EmployeeName", "0"));
    }
