      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">NOTICE MASTER</a>
          </div>
                        ...
                        <div class="panel lobidisable panel-bd">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddldeprt" runat="server" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" AutoPostBack="true"
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddnemp" runat="server"  class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                    </asp:DropDownList>
                                </div></div>
