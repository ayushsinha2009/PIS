...
&nbsp;<a href="AddCareers.aspx">Insert Careers</a>
            ...
            <tr>
                ...
                <td>
                    ...
                    <strong>Leave:-</strong><asp:DropDownList ID="ddnleave" runat="server">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="BtnUpdate" runat="server" OnClick="BtnUpdate_Click" Text="Update" ValidationGroup="l" />
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:GridView ID="GvApply" runat="server" AllowPaging="True" AutoGenerateSelectButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" ForeColor="Black" GridLines="Horizontal" OnPageIndexChanging="GvApply_PageIndexChanging" OnSelectedIndexChanged="GvApply_SelectedIndexChanged" EmptyDataText="No Leave">
