...
using System.Data;
using System.IO;
public partial class Listholiday : System.Web.UI.Page
{
    ...
    {
        i = obj.AddHolidays(txtdate.Text, txttopic.Text, txtdesc.Text, "Admin", DateTime.Now.ToString());
        if (i > 0)
        {
    ...
    {
        u = obj.Updateholidays(Convert.ToInt32(lblId.Text), txtdate.Text, txttopic.Text, txtdesc.Text);
        if (u > 0)
        {
    ...
    protected void Btncncl_Click(object sender, EventArgs e)
    {
        ...
        ClearFields();
        lblmsg.Text = "";
        Response.Redirect("ListOfHolidays.aspx");
    }
